...
| | [`EXT_crs`](https://github.com/CesiumGS/glTF/tree/3d-tiles-2.0/extensions/2.1/Vendor/EXT_crs) (glTF 2.1 extension) <br> Declares the Coordinate Reference System (CRS) in which a glTF 2.1 asset was authored. |
