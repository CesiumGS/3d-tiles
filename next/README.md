...
The 3D Metadata Specification also provides a [Semantic Reference](../specification/Metadata/Semantics), used to describe the semantic meanings of properties. Semantics may be general-purpose (e.g. ID, name, or description), related 3D Tiles (e.g. bounding volumes and occlusion data), or extended and customized for other domains.
