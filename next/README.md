...
glTF content is the future of 3D Tiles, and may be used in place of glTF Tiles 1.0 internal formats (`.b3dm`, `.i3dm`, `.pnts`) in the future. Those internal formats remain available, but glTF offers forward-compatibility with a wider ecosystem of 3D content tools, and with any current and future extensions developed for the glTF format. For technical details on switching to glTF tile content, see the developer [migration guide](https://github.com/donmccurdy/3d-tiles/blob/main/extensions/3DTILES_content_gltf/MIGRATION_GUIDE.md) provided with `3DTILES_content_gltf`.
...
The 3D Metadata Specification also provides a [Semantic Reference](https://github.com/CesiumGS/3d-tiles/tree/main/specification/Metadata/Semantics), used to describe the semantic meanings of properties. Semantics may be general-purpose (e.g. ID, name, or description), related 3D Tiles (e.g. bounding volumes and occlusion data), or extended and customized for other domains.
...
Issues and pull requests are welcome on this repository, in accordance with our guidelines for contributing, in [CONTRIBUTING.md](../CONTRIBUTING.md).
