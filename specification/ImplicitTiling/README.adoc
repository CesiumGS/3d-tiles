...
For more detailed information about working with Morton indices and availability bitstreams, see xref:AVAILABILITY.adoc#implicittiling-availability-indexing[Availability Indexing].
