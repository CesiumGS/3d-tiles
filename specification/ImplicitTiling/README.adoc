...
image::ImplicitTiling/figures/sparse-octree.png[,700]
...
image::ImplicitTiling/figures/quadtree.png[,500]
...
image::ImplicitTiling/figures/octree.png[,500]
...
| image:ImplicitTiling/figures/box.png[pdfwidth=30%]
| image:ImplicitTiling/figures/box-quadtree.png[pdfwidth=30%]
| image:ImplicitTiling/figures/box-octree.png[pdfwidth=30%]
|===
...
| image:ImplicitTiling/figures/region.png[pdfwidth=30%]
| image:ImplicitTiling/figures/region-quadtree.png[pdfwidth=30%]
| image:ImplicitTiling/figures/region-octree.png[pdfwidth=30%]
|===
...
image::ImplicitTiling/figures/box-coordinates.png[,780]
...
image::ImplicitTiling/figures/region-coordinates.jpg[,700]
...
image::ImplicitTiling/figures/template-uri.png[,1020]
...
image::ImplicitTiling/figures/subtree-anatomy.png[subtree anatomy]

After partitioning a tileset into subtrees, the result is a tree of subtrees.

image::ImplicitTiling/figures/subtree-tree.png[Tree of subtrees]
...
image::ImplicitTiling/figures/availability-ordering.png[Availability Ordering]
...
For more detailed information about working with Morton indices and availability bitstreams, see <<implicittiling-appendix-a-availability-indexing,Appendix A: Availability Indexing>>.
...
image::ImplicitTiling/figures/tile-availability.png[Tile Availability]
...
image::ImplicitTiling/figures/content-availability.png[Content Availability]
...
image::ImplicitTiling/figures/child-subtree-availability.png[Child Subtree Availability]
...
image::ImplicitTiling/figures/tile-height-semantics.png[,600]
____
...
image::ImplicitTiling/figures/binary-subtree.png[Subtree Binary Format]
...
[#implicittiling-appendix-a-availability-indexing]
...
image::ImplicitTiling/figures/morton-indexing.png[Morton Order]
...
image::ImplicitTiling/figures/global-to-local-morton.png[,500]
...
image::ImplicitTiling/figures/global-to-local-levels.png[,500]
...
image::ImplicitTiling/figures/global-to-local-xy.png[Global to local XY coordinates]
...
image::ImplicitTiling/figures/parent-and-child-coordinates.png[Parent and child coordinates]
