...
:url-availability: AVAILABILITY.adoc
endif::[]
ifndef::env-github[]
:url-specification: 
...
| image:figures/box.png[pdfwidth=1.5in]
| image:figures/box-quadtree.png[pdfwidth=1.5in]
| image:figures/box-octree.png[pdfwidth=1.5in]
|===
...
| image:figures/region.png[pdfwidth=1.5in]
| image:figures/region-quadtree.png[pdfwidth=1.5in]
| image:figures/region-octree.png[pdfwidth=1.5in]
|===
...
For more detailed information about working with Morton indices and availability bitstreams, see xref:{url-availability}#implicittiling-availability-indexing[Availability Indexing].
