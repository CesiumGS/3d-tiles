...
For JSON encoding, basic types include integers, floating point numbers, booleans, and strings. These are encoded in whatever JSON type is most. Numeric types are represented as `number`, booleans as `boolean`, and strings as `string`.
