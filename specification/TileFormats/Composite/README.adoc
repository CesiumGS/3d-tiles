...
WARNING: Composite was deprecated in 3D Tiles 1.1. See See xref:{url-specification-tileformats-gltf}README.adoc#tileformats-gltf-composite-cmpt[`cmpt` migration guide].
