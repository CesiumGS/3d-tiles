...
WARNING: Composite was deprecated in 3D Tiles 1.1. See link:../glTF/README.md#composite-cmpt[`cpmt` migration guide].
...
image::TileFormats/Composite/figures/layout.png[]
