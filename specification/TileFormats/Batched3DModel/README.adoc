...
WARNING: Batched 3D Model was deprecated in 3D Tiles 1.1. See xref:{url-specification-tileformats-gltf}README.adoc#tileformats-gltf-batched-3d-model-b3dm[`b3dm` migration guide].
