...
See the See xref:{url-specification-tileformats-gltf}README.adoc#tileformats-gltf-appendix-a-migration-from-legacy-tile-formats[migration guide]. for further information about how these use cases can be modeled based on the glTF tile format.
