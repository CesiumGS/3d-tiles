...
WARNING:  Batch Table was deprecated in 3D Tiles 1.1. See xref:{url-specification-tileformats-gltf}README.adoc#tileformats-gltf-migration-from-legacy-tile-formats[glTF migration guide].
