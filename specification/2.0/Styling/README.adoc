...
:url-extension-metadata: ../../extensions/3DTILES_metadata/README.adoc
endif::[]
ifndef::env-github[]
:url-specification:
:url-specification-tileformats:
:url-extension-metadata:
endif::[]
