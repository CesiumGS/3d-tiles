...
.Normative Note
====
The normative definition of implicit tiling, including the subdivision schemes, availability of tiles, and subtree formats, is defined by the `3DTILES_implicit_tiling` glTF extension. This section provides an informative overview.
====
...
The JSON structure of a subtree is normatively defined by the JSON schema in the `3DTILES_subtree` extension.
