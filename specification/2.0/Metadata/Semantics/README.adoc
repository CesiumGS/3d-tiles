...
* https://github.com/CesiumGS/glTF/blob/3d-tiles-2.0/extensions/2.0/Vendor/EXT_structural_metadata[`EXT_structural_metadata`] (glTF 2.0+) --  Assigns metadata to vertices, texels, and features in a glTF asset.
...
* Type: `STRING`
* Array: `true`
| The union of all the feature ID labels in glTF content using the https://github.com/CesiumGS/glTF/tree/3d-tiles-2.0/extensions/2.0/Vendor/EXT_mesh_features[`EXT_mesh_features`] and https://github.com/CesiumGS/glTF/tree/3d-tiles-2.0/extensions/2.0/Vendor/EXT_instance_features[`EXT_instance_features`] extensions.
...
* Type: `SCALAR`
* Component type: `UINT64`
| The bounding volume of the tile, expressed as an link:https://github.com/CesiumGS/3d-tiles/tree/main/extensions/3DTILES_shape_s2/README.md#cell-ids[S2 Cell ID] using the 64-bit representation instead of the hexadecimal representation. Only applicable to link:https://github.com/CesiumGS/3d-tiles/tree/main/extensions/3DTILES_shape_s2/README.md[`3DTILES_shape_s2`].
