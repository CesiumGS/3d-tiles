...
* https://github.com/CesiumGS/glTF/blob/3d-tiles-2.0/extensions/2.0/Vendor/EXT_mesh_features[`EXT_mesh_features`] (glTF 2.0+) --  Assigns identifiers to geometry and subcomponents of geometry within a glTF asset.
